...
<script>
    ...
    $('.data_type').each(function(i, obj) {
        displayDataTypeParams($(this));
    });

    $('.html_type').each(function(i, obj) {
        displayOptions($(this));
    });
    ...
    $(document).ready(function () {
        // attribute tr
        var tr = "<tr class='form-inline'> <td><input type='hidden' name='id[]' value='{{old('id', optional($generatorTableField)->id)}}'><input type='text' name='field_name[]' style='width: 100%' required='true' class='form-control'></td>";
        ...
        // id Attribute tr
        var pkTr = "<tr> <td><input type='hidden' name='id[]'><input type='text' name='field_name[]' style='width: 100%' required class='form-control' value='id' readonly></td>";
    ...
    // Gérer les suppressions de lignes
