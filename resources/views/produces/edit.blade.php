                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">{{ !empty($title) ? $title : 'Produces' }}</h6>
                            </div>
                        </div>
                        <div class="card-body px-0 pb-2">
                            <div class="container-fluid">
                                ...
                                <form method="POST" action="{{ route('produces.produces.update', $produces->id) }}" id="edit_produces_form" name="edit_produces_form" accept-charset="UTF-8" class="form-horizontal">
                                {{ csrf_field() }}
