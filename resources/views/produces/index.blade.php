                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Farm Produces</h6>
                            </div>
                        </div>
                        <div class="card-body px-0 pb-2">
                            ...
                            @endif
                            @if(count($producesObjects) == 0)
                                <div class="container-fluid text-center">
                                    <h4>No Produces Available.</h4>
                                </div>
                            @else
                            <div class="container-fluid">
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-striped ">
                                        ...
                                        <tbody>
                                        @foreach($producesObjects as $produces)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    {{ csrf_field() }}
                                                        ...
                                                        <div class="btn-group btn-group-xs pull-right" role="group">
                                                            <a href="{{ route('produces.produces.show', $produces->id ) }}" class="btn btn-info" title="Show Produces">
