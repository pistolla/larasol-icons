...
return [
    ...
    'ward_id' => 'Ward',
    'ward_id__placeholder' => 'Select ward',
    'ward_name' => 'Ward Name',
    'access_token_with_bearer' => 'The access token prefixed with the "Bearer " key word.',
    'index_route_description' => 'Retrieve existing wards.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the wards property name where the value is the assigned value to the retrieved wards.',
    ...
    'show_route_description' => 'Retrieve existsing wards.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the wards to retrieve',
    'destroy_route_description' => 'Delete existsing wards.',
    ...
    'the_id_of_model_to_delete' => 'The id of the wards to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete wards.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the wards.',
    ...
    'the_requested_model_does_not_exists' => 'The requested wards does not exists.',
    ...
    'create' => 'Create New Wards',
    'delete' => 'Delete Wards',
    'edit' => 'Edit Wards',
    'show' => 'Show Wards',
    'show_all' => 'Show All Wards',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Wards.',
    'none_available' => 'No Wards Available.',
    'model_plural' => 'Wards',
    'model_was_added' => 'Wards was successfully added.',
    'model_was_retrieved' => 'Wards was successfully retrieved.',
    'models_were_retrieved' => 'Wards were successfully retrieved.',
    'model_was_updated' => 'Wards was successfully updated.',
    'model_was_deleted' => 'Wards was successfully deleted.',
